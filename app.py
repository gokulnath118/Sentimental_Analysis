...
def home():
    ...
    imageha = mpimg.imread('img1.jpg')     
    st.image(imageha)
    st.write('By using LSTM Model, Lets predict  Sentiment in comments more Accurately')
    st.header('About Dataset')
    st.write("The objective is to assess the sentiment of a message toward a particular entity. This dataset comprises three categories: Positive, Negative, and Neutral. Messages unrelated to the entity are categorized as Neutral.")
